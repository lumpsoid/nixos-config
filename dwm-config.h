...
static char normbgcolor[]           = "#f7931d";
/*static char normbordercolor[]       = "#444444";*/
static char normbordercolor[]       = "#f7931d";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#ff8800";
...
static const Key keys[] = {
    ...
    { MODKEY,           XK_n,                     spawn,           {.v = (const char*[]){ TERMINAL, "-e", "go_to_uni", NULL } } },
    ...
    { MODKEY,           XK_Insert,                spawn,           SHCMD("dmenutype") },
    ...
    { 0,                XK_Print,                 spawn,           SHCMD("~/.local/bin/sc-screenshootsh") },
